...
public class SoldCarDAO {
    ...
    // Satılan aracı ekler ve oluşturulan ID'yi SoldCar objesine set eder, döner
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            try (ResultSet generatedKeys = stmt.getGeneratedKeys()) {
                if (generatedKeys.next()) {
                    ...
                    soldCar.setId(generatedId); // Satış ID'si set edilir
                    return generatedId;
                } else {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            while (rs.next()) {
                Car car = new Car(
                    ...
                    "", // image path yok burada
                    0  // car price burada yok, istersen modeline göre ekleyebilirsin
                );
                ...
                soldCar.setId(rs.getInt("id")); // Burada id'yi set ediyoruz
                list.add(soldCar);
            }
        } catch (SQLException e) {
            e.printStackTrace();
